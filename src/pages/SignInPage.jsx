      ...
      <div className="flex-1 flex flex-col items-center px-4 py-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-gray-500">Pet care routines, care sheets & peace of mind.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => login()}
              className="w-full flex items-center justify-center gap-2.5 px-4 py-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="w-full max-w-md mt-12 pt-8 border-t border-gray-100">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wider text-center mb-4">What pet parents say</p>
          <div className="space-y-4">
            <p className="text-sm text-gray-600 text-center italic">&ldquo;One link and my sitter had everything — routines, vet info, allergies. So easy.&rdquo;</p>
            <p className="text-sm text-gray-600 text-center italic">&ldquo;Finally stopped forgetting my dog&apos;s medicine. The reminders are a lifesaver.&rdquo;</p>
          </div>
        </div>
      </div>
